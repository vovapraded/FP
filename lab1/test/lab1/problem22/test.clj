(ns lab1.problem22.test
  (:require [clojure.test :refer [are deftest]]
            [lab1.problem22.s1-1 :as s1-1]
            [lab1.problem22.s1-2 :as s1-2]
            [lab1.problem22.s2&3 :as s2&3]
            [lab1.problem22.s4 :as s4]))

(def impls
  [s1-1/total-names-score
   s1-2/total-names-score
   s2&3/total-names-score
   s4/total-names-score])
